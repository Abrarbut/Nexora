      ...
      <div className="w-full max-w-md">
        ...
        <div className="rounded-2xl border border-slate-700/50 bg-slate-800/50 p-8 backdrop-blur-sm">
          ...
          <button
            ...
            className="flex w-full items-center justify-center gap-3 rounded-lg border border-slate-600 bg-slate-700/30 py-2.5 text-sm font-medium text-slate-300 transition hover:bg-slate-700/50"
          >
